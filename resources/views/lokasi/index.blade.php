        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Tambah Master Lokasi
                    </h5>
    ...
    @foreach ($data as $item)
        ...
        <div class="modal fade" tabindex="-1" role="dialog" id="edit{{ $item->id }}">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Edit Master Lokasi
                        </h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                        ...
                        <form action="{{ route('lokasi.update', $item->id) }}" method="POST">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('nama_lokasi') is-invalid @enderror"
                                        value="{{ old('nama_lokasi', $item->nama_lokasi) }}" name="nama_lokasi" required>
                                    @error('nama_lokasi')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
        ...
        <div class="modal fade" id="hapus{{ $item->id }}">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>Apakah anda yakin menghapus data -> <b>{{ $item->nama_lokasi }} ?</b> </p>
                    </div>
