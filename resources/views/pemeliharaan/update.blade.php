...
@section('title', 'Update Data Pemeliharaan')
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control @error('tgl_perbaikan') is-invalid @enderror"
                                        value="{{ old('tgl_perbaikan', $data->tgl_perbaikan) }}" name="tgl_perbaikan">
                                    @error('tgl_perbaikan')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    value="{{ old('jam_perbaikan', $data->jam_perbaikan) }}" name="jam_perbaikan">
                                @error('jam_perbaikan')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
